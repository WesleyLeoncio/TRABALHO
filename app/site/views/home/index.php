        ...
        <div class="carousel-inner">
            ...
            foreach ($this->dados['carousel'] as $carousel) {
                ...
                <div class="carousel-item <?php if ($cont == 0) echo "active"; ?>">
                    <img class="first-slide" src="<?= URL . '/assets/img/carousel/' . $id . '/' . $imagem; ?>" alt="First slide" />
                    <div class="container">
        ...
        <div class="row">
            ...
            foreach ($this->dados['servicos'] as $servico) {
                ...
                <div class="col-lg-4 <?= $anima[$cont]; ?>">
                    <img class="rounded-circle" src="<?= URL . '/assets/img/servico/' . $id . '/' . $imagem; ?>" alt="<?= $nome; ?>" title="<?= $nome; ?>" width="140" height="140">
                    <h2><?= $nome; ?></h2>
                    <p><?= $descricao; ?></p>
        ...
        <div class="row">
            ...
            foreach ($this->dados['noticias'] as $noticia) {
                ...
                <div class="col-md-4 <?= $anima[$cont]; ?>">
                    <img class="" src="<?= URL . '/assets/img/noticia/' . $id . '/' . $imagem; ?>" alt="<?= $titulo ?>" title="<?= $titulo; ?>" width="300" height="200">
                    <h2><?= $titulo; ?></h2>
                    <p><?= $descricao; ?> </p>
                    <p><a class="btn btn-<?= $cor; ?>" href="<?= URL . 'noticia/visualizar/' . $slug; ?>" role="button">Ver mais &raquo;</a></p>
                </div>
            <?php
                $cont++;
            }
